...
7. **Per-Phase Branching:** Work should be performed on a dedicated branch for each phase, merged back to the main branch only after phase completion and verification.
...
8. **Commit Code Changes with Summary:**
   ...
   - Draft a detailed summary for the completed task, including the task name, a summary of changes, and the core "why" for the change.
   - Propose a clear, concise commit message that includes this summary in the body.
   - Perform the commit.
...
6.  **Create Checkpoint Commit:**
    ...
    -   Perform the commit with a clear and concise message (e.g., `conductor(checkpoint): Checkpoint end of Phase X`) that includes the verification report in the body.
...
9. **Merge Phase Branch:**
    - **Action:** Merge the current phase branch into the main branch.
    - **Action:** Delete the phase branch.

10.  **Announce Completion:** Inform the user that the phase is complete, verified, and merged.
